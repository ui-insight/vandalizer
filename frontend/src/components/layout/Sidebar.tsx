import { BookOpen, ClipboardCheck, Cloud, FileText, Globe, Headphones, MessageSquare, Shield, ShieldCheck, Users, Workflow, Zap } from 'lucide-react'
...
export function Sidebar() {
  ...
  const links = [
    ...
    { href: '/catalog', label: 'Catalog', icon: ShieldCheck },
