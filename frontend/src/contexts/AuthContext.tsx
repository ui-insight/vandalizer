...
interface AuthContextValue {
  ...
  register: (userId: string, email: string, password: string, name?: string, inviteToken?: string, joinLinkToken?: string, roleSegment?: string) => Promise<void>
  logout: () => Promise<void>
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const register = useCallback(
    async (userId: string, email: string, password: string, name?: string, inviteToken?: string, joinLinkToken?: string, roleSegment?: string) => {
