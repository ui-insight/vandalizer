...
class TestWorkflowRun:
    ...
    def test_verify_doc_title(self, driver, config):
    ...
    def test_verify_workflow_title(self, driver, config):
        title_element = WebDriverWait(driver, 5).until(
    ...
    def test_click_run(self, driver):
