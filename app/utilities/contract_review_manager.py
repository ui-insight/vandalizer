...
class ContractReviewManager:
    ...
    def fetch_sections(self, document):
        document_sections = self.llmManager.ask_document("Consider the document: " + document + ". Give me a list of all sections in the contract, formatted as a csv with a comma between each section.")
    ...
    def get_compliance(self, document, section):
        ...
        result = self.llmManager.ask_document(prompt)
