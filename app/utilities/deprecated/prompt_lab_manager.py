...
class PromptLabManager:
    ...
    def run(self, model, promptChain, documents, vector):
        ...
        if model == "gpt-4" or model == "gpt-3.5-turbo-16k" or model == "gpt-3.5-turbo":
            llm = ChatOpenAI(model_name=model, openai_api_key="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")
        else:
            llm = OpenAI(model_name=model, openai_api_key="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")
