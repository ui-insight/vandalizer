...
def admin_config_add_model():
    ...
    model_external = request.form.get("model_external")
    model_thinking = request.form.get("model_thinking")

    
    external = parse_bool(model_external)
    thinking = parse_bool(model_thinking)
