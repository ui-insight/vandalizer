"""Starter-examples version helpers used by the in-app upgrade feature."""
    ...
    for admin in admins:
        try:
            await notification_service.create_notification(
                ...
                body=f"Your starter examples are at {applied}. Review and apply the update from Admin → Catalog.",
